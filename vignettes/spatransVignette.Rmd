...
The _spatrans_ package can be computationally intensive, especially for transcript pairs. For this reason we provide multithreading through the _BiocParallel_ package. All the user needs to do is prepare the parallel backend as follows:
...
Alternatively, a wrapper function is available that fits such LMMs for every transcript:
