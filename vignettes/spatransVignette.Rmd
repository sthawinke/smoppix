...
A second dataset used is the one by \textcite{Eng2019} on mouse fibroblast cells, which will serve to illustrate methods given knowledge of cell boundaries. The hyperframe is built as before:
...
## Vicinity to cell edge or centroid

## Within-cell localization patterns

### Global spatial distribution of intracellular patterns


## Tests for vicinity to cell wall or centroid: distances to fixed objects
