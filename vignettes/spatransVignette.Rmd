...
The progress bar helps one keep track of the calculations. For serial calculations, for instance if memory is limiting, choose
...
head(getResults(allModsNNpair, "Intercept"))
```
