...
test_that("Plotting hyperframes proceeds without errors", {
    ...
    expect_silent(plotExplore(hypFrame2, piEsts = objCSR, piColourCell = "nnCell", feature = "gene1"))
    expect_silent(plotExplore(hypFrame2, piEsts = objCSR, piColourCell = "nnPairCell", feature = "gene1--gene2"))
})
...
test_that("Plotting hyperframes throws warning when appropriate", {
    ...
    expect_error(plotExplore(hypFrame2, piEsts = objCSR, piColourCell = "nnPairCell", feature = "gene2"))
    expect_error(plotExplore(hypFrame2, piEsts = objCSR, piColourCell = "nnCell", feature = "gene1--gene2"))
})
